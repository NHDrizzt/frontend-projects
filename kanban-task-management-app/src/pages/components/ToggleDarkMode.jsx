...
const ToggleDarkMode = () => {
    ...
    return (
        <div className={`${isScreenLarger && !toggle ? 'absolute left-6 bottom-0 mb-16': ''} ${'w-60 h-12 mt-2 gap-x-5 mx-auto flex items-center justify-center bg-almostWhite dark:bg-darkGray rounded-md'}`}>
